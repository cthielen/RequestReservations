...
set :application, "requestreservations"
set :user, "deployer"
...
set :scm, "git"
set :repository, "git@github.com:cthielen/RequestReservations.git"
set :branch, "master"
...
namespace :deploy do
  ...
  task :setup_config, roles: :app do
    ...
    put File.read("config/dss-rm.example.yml"), "#{shared_path}/config/dss-rm.yml"
  ...
  task :symlink_config, roles: :app do
    ...
    run "ln -nfs #{shared_path}/config/dss-rm.yml #{release_path}/config/dss-rm.yml"
